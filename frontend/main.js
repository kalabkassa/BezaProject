...
var server = 'ws://192.168.8.6:8000/update/temp/';
...
const MainPage = ({navigation}) => {
  ...
  return (
    <View style={{paddingTop: 70, flex: 1}}>
      <View style={{position: 'absolute', paddingTop: 20, paddingLeft: 20}}>
        <TouchableOpacity onPress={handleUsernamePress}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            <Text style={{fontWeight: 'bold', marginRight: 20, marginTop: 10}}>
              {username}
            </Text>
      ...
      <View
        style={{flexDirection: 'row', marginTop: 1000, shadowColor: 'black'}}>
        <Switch
